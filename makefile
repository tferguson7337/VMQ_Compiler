...
cVMQ:		${CDIR}/lexer.c ${CDIR}/parser.tab.c \
		...
		${CDIR}/data_lists.c ${CDIR}/data_rep.c ${CDIR}/error_handling.c \
		${CDIR}/eval.c ${CDIR}/eval_array.c ${CDIR}/eval_assign.c \
		${CDIR}/eval_function_call.c ${CDIR}/eval_if.c ${CDIR}/eval_incrementation.c \
		${CDIR}/eval_input.c ${CDIR}/eval_math.c ${CDIR}/eval_output.c \
		${CDIR}/eval_conditional.c ${CDIR}/eval_return.c ${CDIR}/eval_while.c \
		${CDIR}/fileIO.c ${CDIR}/helper_functions.c ${CDIR}/scope.c ${CDIR}/symbol_table.c \
		...
		${CDIR}/eval_input.c ${CDIR}/eval_math.c ${CDIR}/eval_output.c \
		${CDIR}/eval_conditional.c ${CDIR}/eval_return.c ${CDIR}/eval_while.c \
		${CDIR}/fileIO.c ${CDIR}/helper_functions.c ${CDIR}/scope.c ${CDIR}/symbol_table.c ${ERR_OUT}
